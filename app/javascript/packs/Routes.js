...
import ConceptNew from './concepts/ConceptNew'
...
const Routes = (props) => {
  ...
  return (
    <Switch>
      ...
      <PrivateRoute exact path="/concepts/new" auth={state} component={ConceptNew} />
      ...
      <PrivateRoute exact path="/patients/new" auth={state} component={PatientNew} />
